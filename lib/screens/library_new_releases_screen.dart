...
class LibraryNewReleasesScreen extends ConsumerWidget {
  const LibraryNewReleasesScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final newSongsAsync = ref.watch(newestSongsProvider);
          ...
          slivers: [
            ...
            newSongsAsync.when(
              ...
              error: (e, _) => SliverFillRemaining(
                hasScrollBody: false,
                child: const Center(
                  child: Text('Error loading new releases', style: TextStyle(color: spotifyLightGrey)),
                ),
              ),
              data: (songs) {
                if (songs.isEmpty) {
                  return const SliverFillRemaining(
                    hasScrollBody: false,
                    child: Center(
                      child: Text('No new releases yet', style: TextStyle(color: spotifyLightGrey)),
                    ),
                  );
                }
