...
class _UserTracksScreenState extends ConsumerState<UserTracksScreen> {
  ...
  Widget build(BuildContext context) {
    final ui = ref.watch(playerUiStateProvider).value;
    final currentMediaItem = ui?.currentMediaItem;
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Tap the button below or in the top right corner to upload your first audio track to Tunefy!',
                            textAlign: TextAlign.center,
                            style: TextStyle(
