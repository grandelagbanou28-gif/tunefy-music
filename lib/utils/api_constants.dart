class ApiConstants {
  ...
  /// Jamendo API client id (free, keyless streaming of Creative-Commons
  /// music). Used as the fast/reliable primary source, YouTube as fallback.
  static const String jamendoClientId = '25428729';
}
